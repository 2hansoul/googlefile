...
<head>
	...
	<link href="/skysms/css/menu.css" rel="stylesheet" type="text/css">
</head>
	...
	<div class="headTop">
		<div class="innerWrap">
			...
			<?php if (!$login_session) { ?>
				...
				<div class="btnsWrap">
					<a href="/easy/" class="btnsFav" title="간편ttt속"></a>
				...
				<div class="sitm">
					...
					<ul class="deftLst">
						<li class="tp">
							<a href="/skysms/project/login/login.php" class="txt">로그인</a>
						</li>
						<li class="tp">
					...
					<div class="sitm">
						<div class="userInfo">
							<div class="intmg">
								...
								<a href="/skysms/project/login/logout.php" class="btns init txts"><span class="line"></span>로그아웃</a>
							</div>
							<div class="intfil">
								<div class="inftLt">
									<div class="infli">
