<?php
include  $_SERVER['DOCUMENT_ROOT']. "/skysms/header/header.php";
      ...
      <h2 style="margin-top: 14px;">LOG IN</h2>
        <div class="div_login">
          <form method="POST" name="myform" action="../login/loginact.php" onsubmit="return check()">
              ...
              <img  id="loginIMG" src="/skysms/img/menuicon/free-icon-user-shape-25634.png" class="imgmenu1">
              <div class="input_id">
                <input type="text"  class="tempInput" name="id" id="id" placeholder="userid">
              </div>

              <img id="passIMG"src="/skysms/img/menuicon/premium-icon-padlock-3934062.png" class="imgmenu2">
